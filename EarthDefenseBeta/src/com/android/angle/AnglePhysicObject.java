...
public class AnglePhysicObject extends AngleObject
{
	...
	public void kynetics(AnglePhysicObject other, float normal)
	{
		...
		float mVelX = mVelocity.getmX() * nCos - mVelocity.getmY() * nSin;
		float mVelY = mVelocity.getmY() * nCos + mVelocity.getmX() * nSin;
		float oVelX = other.mVelocity.getmX() * nCos - other.mVelocity.getmY() * nSin;
		float oVelY = other.mVelocity.getmY() * nCos + other.mVelocity.getmX() * nSin;
		...
		mVelocity.setmX(mFinalVelX * nCos - mFinalVelY * nSin);
		mVelocity.setmY(mFinalVelY * nCos + mFinalVelX * nSin);
		other.mVelocity.setmX(oFinalVelX * nCos - oFinalVelY * nSin);
		other.mVelocity.setmY(oFinalVelY * nCos + oFinalVelX * nSin);
	}
