...
public class AngleCircleCollider
{
	...
	{
		float dX = (otherCollider.mObject.mPosition.getmX() + otherCollider.mCenter.getmX()) - (mObject.mPosition.getmX() + mCenter.getmX());
		float dY = (otherCollider.mObject.mPosition.getmY() + otherCollider.mCenter.getmY()) - (mObject.mPosition.getmY() + mCenter.getmY());
	...
	protected void draw(GL10 gl)
	{
		...
		gl.glTranslatef(mObject.mPosition.getmX() + mCenter.getmX(), mObject.mPosition.getmY() + mCenter.getmY(), 0.0f);
