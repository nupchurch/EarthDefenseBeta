...
public class AngleSpriteLayout
{
	...
	public void fillVertexValues(int frame, float[] vertexValues)
	{
		if (frame<roFrameCount)
		{
			vertexValues[0] = -mPivot[frame].getmX();
			vertexValues[1] = roHeight - mPivot[frame].getmY();
			vertexValues[2] = roWidth - mPivot[frame].getmX();
			vertexValues[3] = roHeight - mPivot[frame].getmY();
			vertexValues[4] = -mPivot[frame].getmX();
			vertexValues[5] = -mPivot[frame].getmY();
			vertexValues[6] = roWidth - mPivot[frame].getmX();
			vertexValues[7] = -mPivot[frame].getmY();
		}
